 /** *************************** DI-IT2-FLC.cpp ***************************
 *
 * This code is the implementation of a double input (position error and its derivative) interval type-2 fuzzy logic controller.
 ...
 * the heights of the lower membership functions (alpha_p and alpha_d) from the GUI.
 *
 * **********************************************************************/
 ...
 * Subscribes to the values set by user for P-I-D gains and rates from the graphical interface
 */
