...
void odometryCallback(const nav_msgs::Odometry& odometry_msg){
    ...
    position(2) = odometry_msg.pose.pose.position.z; // barometer also sucks
...
void commandKeyboardCallback(const geometry_msgs::TwistStamped& command_msg){
    ...
    case 1: // velocity control
        ros::param::get("/anafi_bridge/max_horizontal_speed", max_horizontal_speed);
        keyboard_command << max_horizontal_speed*command_msg.twist.linear.x, max_horizontal_speed*command_msg.twist.linear.y,
                max_vertical_speed*command_msg.twist.linear.z, max_yaw_rotation_speed*command_msg.twist.angular.z;
        break;
    case 2: // attitude control
        ros::param::get("/anafi_bridge/max_tilt", max_tilt);
        keyboard_command << -max_tilt*command_msg.twist.linear.y, max_tilt*command_msg.twist.linear.x,
                max_vertical_speed*command_msg.twist.linear.z, max_yaw_rotation_speed*command_msg.twist.angular.z;
        break;
    }
}
...
void commandSkycontrollerCallback(const olympe_bridge::SkyControllerCommand& command_msg){
    ...
    case 1: // velocity control
        ros::param::get("/anafi_bridge/max_horizontal_speed", max_horizontal_speed);
        skycontroller_command << max_horizontal_speed/100*command_msg.x, -max_horizontal_speed/100*command_msg.y, max_vertical_speed/100*command_msg.z, -max_yaw_rotation_speed/100*command_msg.yaw;
        break;
    case 2: // attitude control
        ros::param::get("/anafi_bridge/max_tilt", max_tilt);
        skycontroller_command << max_tilt/100*command_msg.y, max_tilt/100*command_msg.x, max_vertical_speed/100*command_msg.z, -max_yaw_rotation_speed/100*command_msg.yaw;
        break;
    }
}
...
void desiredVelocityCallback(const geometry_msgs::TwistStamped& command_msg){
    ...
    ros::param::get("/anafi_bridge/max_vertical_speed", max_vertical_speed);   
    ros::param::get("/anafi_bridge/max_yaw_rotation_speed", max_yaw_rotation_speed);
    desired_velocity << BOUND(command_msg.twist.linear.x, max_horizontal_speed), BOUND(command_msg.twist.linear.y, max_horizontal_speed), BOUND(command_msg.twist.linear.z, max_vertical_speed),
            BOUND(command_msg.twist.angular.z, max_yaw_rotation_speed);
}
...
void desiredAttitudeCallback(const geometry_msgs::TwistStamped& command_msg){
    ...
    ros::param::get("/anafi_bridge/max_vertical_speed", max_vertical_speed);
    ros::param::get("/anafi_bridge/max_yaw_rotation_speed", max_yaw_rotation_speed);
    desired_attitude << BOUND(command_msg.twist.angular.x, max_tilt), BOUND(command_msg.twist.angular.y, max_tilt), BOUND(command_msg.twist.linear.z, max_vertical_speed),
            BOUND(command_msg.twist.angular.z, max_yaw_rotation_speed);
}
...
void commandCameraCallback(const geometry_msgs::Twist& command_msg){
    ...
    camera_msg.action = ((command_msg.linear.z == 1) << 0) | ((command_msg.linear.z == 2) << 1) | ((command_msg.linear.z == 3) << 2); // TODO: implement it as ROS services
...
SafeAnafi::SafeAnafi(int argc, char** argv){
    ...
    moveto_publisher = node_handle.advertise<olympe_bridge::MoveToCommand>("/anafi/cmd_moveto", 1);
    moveby_publisher = node_handle.advertise<olympe_bridge::MoveByCommand>("/anafi/cmd_moveby", 1);
