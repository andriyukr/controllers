 /** *************************** SI-IT2-FLC.cpp ***************************
 *
 * This code is the implementation of a single input (position error) interval type-2 fuzzy logic controller.
 * It receives the actual and desired poses of the UAV and computes the control signal to the UAV.
 * The user can select the gains (k_p, k_i and k_d) and the heights of the lower membership functions (alpha_p, alpha_i and alpha_d) from the GUI.
 *
 * **********************************************************************/
